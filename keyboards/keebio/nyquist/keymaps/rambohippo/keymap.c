 ...
 * |   ~  |   !  |   @  |   {  |   }  |   |  |  |   =  |   +  |   -  |   _  |   `  |      |
 * |------+------+------+------+------+------|  |------+------+------+------+------+------|
 * | Caps |   #  |   $  |   (  |   )  |   *  |  | Left | Down |  Up  | Right|      |Vol Up|
 * |------+------+------+------+------+------|  |------+------+------+------+------+------|
 * | Shift|   %  |   ^  |   [  |   ]  |   &  |  |      |      | Home | End  |   \  |Vol Dn|
 * |------+------+------+------+------+------|  |------+------+------+------+------+------|
 * |      |      |      |      |      | Space|  |      | ---- |      |      |      |      |
 * `-----------------------------------------'  `-----------------------------------------'
 */
[_RAISE] =  LAYOUT( \
  ...
  KC_TILD, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE, KC_EQL,  KC_PLUS, KC_MINS, KC_UNDS, KC_GRV, _______, \
  KC_CAPS, KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_ASTR, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, KC_VOLU, \
  KC_LSFT, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_AMPR, _______, _______, KC_HOME, KC_END,  KC_BSLS, KC_VOLD, \
