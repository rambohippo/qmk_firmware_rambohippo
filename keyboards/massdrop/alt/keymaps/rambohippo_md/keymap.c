...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MODS] = LAYOUT(
        ...
        KC_CAPS, _______, _______,                            KC_MPLY,                            _______, _______, KC_HOME, KC_PGDN, KC_END  \
    ),
    [_NAV] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, _______, _______, CTAB_BK, CTAB_FW, KC_PGUP, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, _______, _______, ATAB_BK, ATAB_FW, KC_PGDN, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,          _______, _______, \
